...
keys.globalkeys =
  my_table.join(
    ...
    awful.key({modkey, "Shift"}, "t", function () awful.spawn('alacritty') end, {description = "terminal", group = "awesome"}),
    -- Quit Awesome
    ...
    awful.key(
      ...
      {description = "focus previous idx", group = "client"}
    ),
    awful.key(
      {modkey, altkey},
      "Up",
      ...
      {description = "focus next idx", group = "client"}
    ),
    awful.key(
      {modkey, altkey},
      "Left",
