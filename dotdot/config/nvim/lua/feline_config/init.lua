...
local u = require("feline_config.util")
require('feline_config.hl')
...
local c = {
  ...
  lsp_error = {
    provider = function()
      return get_diag(vim.diagnostic.severity.ERROR)
    end,
    hl = "FlnError",
  ...
  lsp_warn = {
    provider = function()
      return get_diag(vim.diagnostic.severity.WARN)
    end,
    hl = "FlnWarn",
  ...
  lsp_info = {
    provider = function()
      return get_diag(vim.diagnostic.severity.INFO)
    end,
    hl = "FlnInfo",
  ...
  lsp_hint = {
    provider = function()
      return get_diag(vim.diagnostic.severity.HINT)
    end,
    hl = "FlnHint",
